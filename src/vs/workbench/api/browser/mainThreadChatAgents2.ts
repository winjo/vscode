...
import { isUntitledChatSession, getChatSessionType } from '../../contrib/chat/common/model/chatUri.js';
...
import { ExtHostChatAgentsShape2, ExtHostContext, IChatAgentInvokeResult, IChatNotebookEditDto, IChatParticipantMetadata, IChatProgressDto, IChatSessionContextDto, IChatSessionCustomizationItemDto, IChatSessionCustomizationProviderMetadataDto, ICustomAgentDto, IDynamicChatAgentProps, IExtensionChatAgentMetadata, IHookDto, IInstructionDto, IPluginDto, ISkillDto, ISlashCommandDto, MainContext, MainThreadChatAgentsShape2 } from '../common/extHost.protocol.js';
